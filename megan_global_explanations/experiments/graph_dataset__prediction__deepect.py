...
def train_model(e: Experiment,
    ...
    graphs_support = random.sample(graphs, k=int(0.1 * len(graphs)))
    ...
    e.log(f'training has finished with {trainer.num_leaves} final clusters')
    
    # ~ Saving the embedding recordings
    # 
    
    e.log('animating the recorded deepect histroy...')
