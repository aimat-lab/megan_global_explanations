...
def train_model(e: Experiment,
    ...
    y = [index_data_map[i]['labels'] for i in indices]
...
def evaluate_model(e: Experiment,
    ...
    vectors_test = [index_data_map[i]['vector'] for i in indices]
    
    out_true = [index_data_map[i]['labels'] for i in indices]
    out_pred = model.predict_vectors(vectors_test)
