...
MODEL_PATH: str = '/media/ssd/Programming/graph_attention_student/graph_attention_student/experiments/results/vgd_torch__megan__compas/debug/rep00/model.ckpt'
