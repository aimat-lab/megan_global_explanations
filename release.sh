#!/usr/bin/env bash
# release.sh - Automated release script for megan_global_explanations
#
...
OLD_VERSION=$(cat megan_global_explanations/VERSION)
...
NEW_VERSION=$(cat megan_global_explanations/VERSION)
...
git add pyproject.toml megan_global_explanations/VERSION README.rst megan_global_explanations/__init__.py
...
# Extract owner/repo from origin URL, stripping any embedded credentials and .git suffix
